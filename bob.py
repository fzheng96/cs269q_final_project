...
def parse_data(data, s):
    ...
    global bell_basis
    if data['name'] == 'alice':
        if data['command'] == 'tell_bob_to_measure':
            message = {'name': 'bob'}
            ...
            s.close()
        elif data['command'] == 'tell_bob_to_reconstruct':
            bell_basis = data['bell_basis']
        elif data['command'] == 'tell_bob_to_send_to_charlie':
            message = {'name': 'bob'}
            message['command'] = 'tell_charlie_to_reconstruct'
        ...
        if data['command'] == 'tell_bob_to_reconstruct':
